public static class HexTacticsAssetPaths
{
    ...
    public const string AttackEffectsVariantFolder = AttackEffectsFolder + "/Variants";
    ...
    public const string UiScreensFolder = UiFolder + "/Screens";
